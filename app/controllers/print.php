...
class FPDF_AutoWrapTable extends FPDF {
    ...
    public function rptDetailData() {
        ...
        //header
			...
			$this->Cell(128 ,5,$this->addres1,0,0);
			$this->Cell(50 ,5,'NO : '.$SoTransacID,0,1);
			//$this->Cell(59 ,5,'',0,1);//end of line
			//$this->Cell(130 ,5,'Type : '.$type,0,0);
			$this->Cell(128 ,5,$this->addres2,0,0);
            ...
            $this->SetX($left +=8); $this->Cell(18,$h,'PartId', 0, 0);
            $this->SetX($left +=18); $this->Cell(150,$h,'Part Name', 0, 0);
            $this->SetX($left +=150); $this->Cell(15,$h,'Qty',0, 1);
             $this->Cell(0,2, '', 0, 1,'C');
			 $this->Cell(0,0.1, '',1, 1,'C');
            $this->SetFont('Arial','',8);
            $this->SetDrawColor(255,255,255);
            $this->SetWidths(array(8,18,150,15));
			...
			$this->SetFont('Arial','',8);
			$this->Cell(45 ,5,'',0,0);
			$this->Cell(55 ,5,'Pemesan,',0,0);
            $this->Cell(65 ,5,'Penerima Order,',0,0);
			$this->Cell(70 ,5,'Disetujui Oleh,',0,1);
			
			 $this->Cell(0,10, '', 1, 1,'C');
			$this->Cell(0,2, '', 0, 1,'C');


			$this->Cell(42 ,5,date('d/m/Y H:i:s'),0,0);
			$this->Cell(53 ,5,'(_________________)',0,0);
            $this->Cell(63 ,5,'(_________________)',0,0);
			$this->Cell(70 ,5,'(_________________)',0,1);
    }

	private function Setaddress($custaddress){
		$stelengt = strlen($custaddress);

        if($stelengt >=40){
            $newenty1 = substr($custaddress,0,40);
            $newenty2 = substr($custaddress,40);
            $this->addres1 = $newenty1;
            $this->addres2 = $newenty2;
        }else{
            $this->addres1 = $custaddress;
        }
	}
