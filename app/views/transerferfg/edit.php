...
<style>
    ...
    /* barast nilangkan panah input number */
                                  ...
                                  <div class="col-md-6">
                                       ...
                                       <div class="row mb-12 mb-2">
                                        ...
                                        <label for="pcs" style="width:23%;" class="col-sm-2 col-form-label">Qty (Pcs)</label>
                                            <div class="col-sm-4">
                                              <input type="number" min=0 id="pcs" value=0 class="form-control text-end">
...
function getListItem(){
  ...
  function edit_row(transno,itemno,warehouse,warehouse2,batchno,Refno,PartId,Quantity,keterangan,price,discount,amount){
  $("#edit_row").fadeOut();
  $("#delete").fadeOut();
      ...
      if(userid ==''){
        ...
        Swal.fire({
		 ...
		 const data ={
		  ...
		  $.ajax({
                url:"<?=base_url?>/invtransferfg/UpdatedataHider",
                method:"POST",
                dataType: "json",
                data:data,
                success:function(result){
